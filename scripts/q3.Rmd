...
The link to the data is [here](https://drive.google.com/uc?id=1DDUz-UnuGz3fzperOSLF2Li7Fbk73WzZ). Please feel free to either read the data in from this link or upload it to your temporary Co-Lab storage and reference its location there.
...
```{r visualize-data}
# Use ggplot2 to visualize a line plot showing PSC fluctuation over a trial
# <YOUR CODE HERE>
```
...
# Create and populate card, video, and judgment columns
# <YOUR CODE HERE>
```
